...
int Master::Run()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, " A World of Warcraft: Mists of Pandaria Core Emulator	");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "       _/_/   _/         _/_/_/_/ ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "    _/    _/ _/_/_/_/   _/        ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "   _/    _/ _/      _/ _/_/_/     ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "  _/    _/ _/      _/ _/          ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "   _/_/   _/      _/ _/_/_/_/ 	 ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "                         C O R E  ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, " https://ApocalypseCore.tk ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, " ApocalypseCore developers (c) 2013");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, " Powered by Apocalypse Team ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, " ApocalypseCore ");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, " Presione <Ctrl-C> para detenerlo.\n");
