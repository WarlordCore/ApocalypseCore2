...
extern int main(int argc, char **argv)
{
    ...
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " A World of Warcraft: Mists of Pandaria Core Emulator	");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "       _/_/   _/         _/_/_/_/ ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "    _/    _/ _/_/_/_/   _/        ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "   _/    _/ _/      _/ _/_/_/     ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "  _/    _/ _/      _/ _/          ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "   _/_/   _/      _/ _/_/_/_/ 	");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " Autentificador de Cuentas   AUTH ");	
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " https://ApocalypseCore.tk/          ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " ApocalypseCore Community developers (c) 2013");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " Powered by Apocalypse Team ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " ApocalypseCore ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " Presione <Ctrl-C> para detenerlo.\n");
			
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " El archivo de configuration usado es %s.", cfg_file);
